            ...
            <div class="row justify-content-center justify-content-lg-start">
                <div class="col-lg-8 text-center text-lg-start">
                    ...
                    <div class="d-flex flex-column flex-sm-row gap-3 justify-content-center justify-content-lg-start">
                        <a href="index.php" class="btn btn-light btn-lg py-3 px-5 fw-semibold">Home</a>
                        <a href="service.php" class="btn btn-outline-light btn-lg py-3 px-5 fw-semibold">Services</a>
                        <a href="product.php" class="btn btn-light btn-lg py-3 px-5 fw-semibold">Products</a>
                    </div>
                </div>
            </div>
        </div>
