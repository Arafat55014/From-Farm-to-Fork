    ...
    <div class="container py-5">
        <div class="row justify-content-center justify-content-lg-start">
            <div class="col-lg-8 text-center text-lg-start">
                <!-- Hero Title -->
                <h1 class="display-3 text-white fw-bold mb-4">Contact Us</h1>

                <!-- Hero Buttons -->
                <div class="d-flex flex-column flex-sm-row gap-3 justify-content-center justify-content-lg-start">
                    <a href="index.php" class="btn btn-light btn-lg py-3 px-5 fw-semibold">
                        Home
                    </a>
                    <a href="contact.php" class="btn btn-outline-light btn-lg py-3 px-5 fw-semibold">
                        Contact Us
                    </a>
                </div>
            </div>
...
<style>
    /* Hero Background as green like Services Hero */
    .bg-hero {
        background-color: #28a745; /* same green for consistency */
        position: relative;
    }
    ...
    .bg-hero h1,
    .bg-hero .btn {
        position: relative; /* appear above overlay */
        z-index: 2;
    }

    /* Buttons styling similar to navbar hover/active */
    .bg-hero .btn {
    ...
    .bg-hero .btn-outline-light:active {
        background-color: #ffd700; /* active color */
        border-color: #ffd700;
                    ...
                    <div class="bg-secondary h-100 p-5">
                        ...
                        <div class="d-flex mb-4">
                            ...
                            <div class="ps-3">
                                ...
                                <span class="text-white">Bashundhara Residential Area, Dhaka</span>
                            </div>
                        </div>
                        <div class="d-flex mb-4">
                            <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center" style="width: 60px; height: 60px;">
                            ...
                            <div class="ps-3">
                                ...
                                <span class="text-white">arafathridoy333@gmail.com</span>
                            </div>
                        </div>
                        <div class="d-flex">
                            <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center" style="width: 60px; height: 60px;">
                            ...
                            <div class="ps-3">
                                ...
                                <span class="text-white">+8801884624832</span>
                            </div>
                        </div>
                    </div>
                </div>
